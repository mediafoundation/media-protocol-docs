...
This document is a living document which represents the current process guidelines for developing and advancing Media Network Governance Proposals.

## Process

Several governance venues are available to Media Network governance, each serving its own particular purpose.

1. [**Media Network Forum**](https://forum.media.network/)

    A Discourse-hosted forum for governance-related discussion. Community members must register for an account before sharing or liking posts. New members are required to enter 4 topics and read 15 posts over the course of 10 minutes before they are permitted to post themselves.

2. [**SnapshotMedia**](https://snapshot.page/#/media)

    SnapshotMedia is a simple voting interface that allows users to signal sentiment off-chain. Votes on snapshot are weighted by the number of MEDIA delegated to the address used to vote.

3. [**Governance Portal**](https://governance.media.network/#/vote)
...
Below we outline a preliminary draft for the Media Network governance process, detailing exactly where these venues fit in. These processes are subject to change according to feedback from the Media community.

### Phase 1: Temperature Check — Discourse/SnapshotMedia

The purpose of the Temperature Check is to determine if there is sufficient will to make changes to the status quo.

To create a Temperature Check:

1. Ask a general, non-biased question to the community on gov.media.network about a potential change (example: "Should Media Network governance add a new feature?"). Forum posts should be labeled as: "Temperature Check - [Your Title Here]". The forum post should include a link to the associated SnapshotMedia poll.
...
### Phase 2: Consensus Check — Discourse/SnapshotMedia
