...
1. [**Media Protocol Forum**](https://forum.media.network/)
...
1. Ask a general, non-biased question to the community on gov.media.network about a potential change (example: "Should Media Protocol governance add a new feature?"). Forum posts should be labeled as: "Temperature Check - [Your Title Here]". The forum post should include a link to the associated SnapshotMedia poll.
