    ...
    description: (
      <>
        ...
        <a href="./overview" target="_blank">
          Learn more about the Media Protocol
        </a>
        .
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <a href="https://www.media.network" target="_blank">
          Visit Media Network's website
        </a>{" "}
        to learn more.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        ...
        Media Protocol and Media Network. Get the latest updates from the{" "}
        <a href="https://x.com/Media_FDN" target="_blank">
          Media Foundation's X profile
        </a>
        .
      </>
    ),
...
export const GovernanceItems = [
  {
    ...
    url: "https://gov.mediaprotocol.net/",
    logo: <svg
    width={24} height={24} 
  ...
  },
  {
    ...
    url: "https://snapshot.org/#/mediaprotocol.eth",
