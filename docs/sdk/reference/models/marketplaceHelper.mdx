...
- **Parameters**:
- `params`: [`AddLiquidityAndRegisterWithETHParams`](../types/params/AddLiquidityAndRegisterWithETHParams)
...
- **Parameters**:
- `params`: [`AddLiquidityAndRegisterParams`](../types/params/AddLiquidityAndRegisterParams)
...
- **Parameters**:
- `params`: [`SwapAndCreateDealParams`](../types/params/SwapAndCreateDealParams)
...
- **Parameters**:
- `params`: [`SwapAndCreateDealWithETHParams`](../types/params/SwapAndCreateDealWithETHParams)
...
- **Parameters**:
- `params`: [`SwapAndCreateDealsParams`](../types/params/SwapAndCreateDealsParams)
...
- **Parameters**:
- `params`: [`SwapAndCreateDealsWithETHParams`](../types/params/SwapAndCreateDealsWithETHParams)
