...
- `authorizedProxies`: Mapping of authorized addresses.
- `authorizedAddresses`: Array of authorized addresses.
- `protocolFeeTo`: Address that will receive the protocol fees.
- `protocolFeeRate`: The rate of the protocol fees.
- `marketplacesCounter`: Counter for the marketplaces.
- `owners`: Mapping of marketplace owners.
- `marketFeeTo`: Mapping of marketplaces fee recipients.
- `marketFeeRate`: Mapping of marketplaces fee rates.
- `REQUIRED_STAKE`: Mapping of required stakes for providers.
- `offerCounter`: Mapping of offer counters.
- `offerAutoIncrement`: Mapping of offer auto-increments.
- `dealAutoIncrement`: Mapping of deal auto-increments.
- `positionManager`: Uniswap V3 position manager.
