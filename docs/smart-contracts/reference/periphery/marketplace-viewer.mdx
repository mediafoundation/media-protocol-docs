...
This contract, `MarketplaceViewer`, acts as a viewer for the `Marketplace` contract. It provides functions that allow users to retrieve `Offers` and `Deals` in a paginated manner. Its aim is to improve the readability and accessibility of the data stored in the `Marketplace` contract.
...
| Type      |                                                    |
|-----------|----------------------------------------------------|
| [`Offer[] memory`](../core/marketplace#Offer) | An array of offers.                       |
